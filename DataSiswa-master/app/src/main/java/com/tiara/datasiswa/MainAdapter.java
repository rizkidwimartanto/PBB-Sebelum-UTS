...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    public List<DataModel> arrayList = new ArrayList<>();
    public MainAdapter(Context mContext, List<DataModel> albumList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        final DataModel siswa = arrayList.get(position);
        holder.textName.setText(siswa.name);
        holder.textAddress.setText(siswa.harga);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(holder.itemView.getContext(), ActionData.class);
